...
exports.WoopSocialPostPublishedTrigger = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const EVENT_TYPE = 'socialAccountPost.delivery.published';
...
class WoopSocialPostPublishedTrigger {
    constructor() {
        this.description = {
            displayName: 'WoopSocial Watch Published Posts Trigger',
            name: 'woopSocialPostPublishedTrigger',
            icon: { light: 'file:../WoopSocial/woopSocial.svg', dark: 'file:../WoopSocial/woopSocial.dark.svg' },
            group: ['trigger'],
            version: 1,
            description: 'Fires when a WoopSocial post is delivered successfully',
            defaults: {
                name: 'WoopSocial Watch Published Posts Trigger',
            },
            inputs: [],
            outputs: ['main'],
            usableAsTool: true,
            ...
            default: {
                ...
                async create() {
                    try {
                        ...
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), {
                            message: `${extractErrorMessage(error, 'Failed to register published-post webhook.')} Hint: Ensure WEBHOOK_URL is a public HTTPS URL and your WoopSocial key can create webhooks.`,
                        });
                    }
                },
                async delete() {
...
exports.WoopSocialPostPublishedTrigger = WoopSocialPostPublishedTrigger;
//# sourceMappingURL=WoopSocialPostPublishedTrigger.node.js.map